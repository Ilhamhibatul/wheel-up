        ...
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('products') }}" class="text-dark">Semua Jenis</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Sepeda Detail</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="col">
                    <table class="table" style="border-top : hidden">
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <img src="{{ url('assets/sepedas') }}/{{ $product->sepeda->gambar }}" class="img-fluid" width="50">
                            </td>
                        </tr>
                        <tr>
                            <td>Spesifikasi</td>
